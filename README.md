...
2.	Die Installation der Extension erfolgt über den Extension Manager -> Upload Extension oder falls das nicht funktioniert, Upload der Extension per FTP auf den Server in das EXT-Verzeichnis der Typo3-Installation und anschließend Installation per Extension Manager. <br>
